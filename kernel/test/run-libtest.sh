#!/bin/sh
# Boot the kernel and let the shell run the twenty-one lib/test programs off the image,
...
# the fsck and the twenty-one diffs are ctest cases of their own (libtest_fsck,
