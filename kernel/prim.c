 ...
 */
getc(p) register struct clist *p;
{
 ...
 */
q_to_b(q, cp, cc) register struct clist *q;
register char *cp;
{
    register struct cblock *bp;
    register int s;
 ...
 */
ndqb(q, flag) register struct clist *q;
{
    register cc;
    int s;
 ...
 */
ndflush(q, cc) register struct clist *q;
register cc;
{
    register s;
...
putc(c, p) register struct clist *p;
{
    register struct cblock *bp;
    register char *cp;
    register s;
 ...
 */
b_to_q(cp, cc, q) register char *cp;
struct clist *q;
register int cc;
{
    register char *cq;
 ...
 * using clists
 */
getw(p) register struct clist *p;
{
    register int s;
...
putw(c, p) register struct clist *p;
{
    register s;
