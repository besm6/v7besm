...
char *btab[] = { "hd", "fd", "md", 0 };

char *ctab[] = { "console", "mem", "tty", "sr", "hd", "fd", "md", "cd", 0 };
...
char *strg1a[] = { "int    mpxchan();", "int    (*ldmpx)() = mpxchan;", 0 };
...
char *strh[] = { "    0", "};", "",
                 "int ttyopen(), ttyclose(), ttread(), ttwrite(), ttyinput(), ttstart();", 0 };

char *stri[] = { "int pkopen(), pkclose(), pkread(), pkwrite(), pkioctl(), pkrint(), pkxint();",
                 0 };

char *strj[] = { "struct linesw linesw[] =", "{",
                 "    ttyopen, nulldev, ttread, ttwrite, nodev, ttyinput, ttstart, /* 0 */", 0 };

char *strk[] = { "    pkopen, pkclose, pkread, pkwrite, pkioctl, pkrint, pkxint, /* 1 */", 0 };
