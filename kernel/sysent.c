...
struct sysent sysent[64] = {
    ...
    { 2, 0, ssig },    // 48 = sig
    { 4, 0, kctl },    // 49 = kctl; v7's "reserved for USG", this port's own call
    { 2, 0, statfs },  // 50 = statfs; v7's "reserved for USG", this port's own call
    ...
    { 0, 0, nosys },   // 56 = unused (was mpxchan)
