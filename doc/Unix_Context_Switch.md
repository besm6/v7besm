...
[`Besm6_Kernel_Reference.md`](Besm6_Kernel_Reference.md) ("The u-area invariant") lists the sites that obey it —
...
nothing. That is the price of a one-page u-area, and it is the one we chose to pay ([`Besm6_Kernel_Reference.md`](Besm6_Kernel_Reference.md), "Known consequences, accepted"). So Dubna's
