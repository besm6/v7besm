...
//
// Finish the processor. Lifecycle hook, kept as an instance method.
//
...
void Processor::reset()
{
    ...
    // Do not print to stdout, which belongs to the simulated program;
    // only report the reset when tracing is enabled.
    if (Machine::trace_enabled()) {
        Machine::get_trace_stream() << "--- Reset" << std::endl;
    }
}
