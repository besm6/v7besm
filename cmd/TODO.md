 ...
 * LD-3: wire cmd/ld into the top-level CMake and build b6ld; fix warnings/errors. Split
   ld.c into an `ld` engine library + thin main.c and add cmd/ld/test/ld_test.cpp. (Related:
   the LD-2 relhalf() 15-bit mask fix lives in this same ld.c.)
