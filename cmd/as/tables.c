...
// '.', '_' and '$' are flagged as letters so they may appear in names, as is
// any high-bit byte 0200-0377, so UTF-8 multibyte characters (including
// Cyrillic) are valid in names.  While a machine instruction is expected the
// lexer also treats '+ - * /' as letters so mnemonics like "a+x" scan as a
// single name (see read_name()).  So e.g. '0'..'7' carry 1|2|4 = 7, '8'/'9'
// carry 1|4 = 5, and 'A'..'F'/'a'..'f' carry 1|8 = 9.
const int ctype[256] = {
    0, 0, 0, 0, 0, 0, 0, 0, // 000 nul  001 soh  002 stx  003 etx  004 eot  005 enq  006 ack  007 bel
    0, 0, 0, 0, 0, 0, 0, 0, // 010 bs   011 ht   012 nl   013 vt   014 np   015 cr   016 so   017 si
    0, 0, 0, 0, 0, 0, 0, 0, // 020 dle  021 dc1  022 dc2  023 dc3  024 dc4  025 nak  026 syn  027 etb
    0, 0, 0, 0, 0, 0, 0, 0, // 030 can  031 em   032 sub  033 esc  034 fs   035 gs   036 rs   037 us
    0, 0, 0, 0, 8, 0, 0, 0, // 040 sp   041  !   042  "   043  #   044  $   045  %   046  &   047  '
    0, 0, 0, 0, 0, 0, 8, 0, // 050  (   051  )   052  *   053  +   054  ,   055  -   056  .   057  /
    7, 7, 7, 7, 7, 7, 7, 7, // 060  0   061  1   062  2   063  3   064  4   065  5   066  6   067  7
    5, 5, 0, 0, 0, 0, 0, 0, // 070  8   071  9   072  :   073  ;   074  <   075  =   076  >   077  ?
    0, 9, 9, 9, 9, 9, 9, 8, // 100  @   101  A   102  B   103  C   104  D   105  E   106  F   107  G
    8, 8, 8, 8, 8, 8, 8, 8, // 110  H   111  I   112  J   113  K   114  L   115  M   116  N   117  O
    8, 8, 8, 8, 8, 8, 8, 8, // 120  P   121  Q   122  R   123  S   124  T   125  U   126  V   127  W
    8, 8, 8, 0, 0, 0, 0, 8, // 130  X   131  Y   132  Z   133  [   134  \   135  ]   136  ^   137  _
    0, 9, 9, 9, 9, 9, 9, 8, // 140  `   141  a   142  b   143  c   144  d   145  e   146  f   147  g
    8, 8, 8, 8, 8, 8, 8, 8, // 150  h   151  i   152  j   153  k   154  l   155  m   156  n   157  o
    8, 8, 8, 8, 8, 8, 8, 8, // 160  p   161  q   162  r   163  s   164  t   165  u   166  v   167  w
    8, 8, 8, 0, 0, 0, 0, 0, // 170  x   171  y   172  z   173  {   174  |   175  }   176  ~   177 del
    8, 8, 8, 8, 8, 8, 8, 8, // 0200 - 0207
    8, 8, 8, 8, 8, 8, 8, 8, // 0210 - 0217
    8, 8, 8, 8, 8, 8, 8, 8, // 0220 - 0227
    8, 8, 8, 8, 8, 8, 8, 8, // 0230 - 0237
    8, 8, 8, 8, 8, 8, 8, 8, // 0240 - 0247
    8, 8, 8, 8, 8, 8, 8, 8, // 0250 - 0257
    8, 8, 8, 8, 8, 8, 8, 8, // 0260 - 0267
    8, 8, 8, 8, 8, 8, 8, 8, // 0270 - 0277
    8, 8, 8, 8, 8, 8, 8, 8, // 0300 - 0307
    8, 8, 8, 8, 8, 8, 8, 8, // 0310 - 0317
    8, 8, 8, 8, 8, 8, 8, 8, // 0320 - 0327
    8, 8, 8, 8, 8, 8, 8, 8, // 0330 - 0337
    8, 8, 8, 8, 8, 8, 8, 8, // 0340 - 0347
    8, 8, 8, 8, 8, 8, 8, 8, // 0350 - 0357
    8, 8, 8, 8, 8, 8, 8, 8, // 0360 - 0367
    8, 8, 8, 8, 8, 8, 8, 8, // 0370 - 0377
};
