// The definitions of everything ldefs.h declares extern.  Included exactly once.
#ifndef ONCE_H
#define ONCE_H

// The identity translation; `%t' overwrites it.  ZCH is gone -- it could only
// ever equal NCH once the alphabet was the whole byte.
int ctable[NCH] = {
...
// stdout is not a constant expression, so errorf cannot be initialised here;
// main() assigns it.  README.md, "The skeleton".
FILE *fout, *errorf;
